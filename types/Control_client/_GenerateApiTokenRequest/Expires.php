 ...
 *
 * Generated from protobuf message <code>control_client._GenerateApiTokenRequest.Expires</code>
 */
...
class_alias(Expires::class, \Control_client\_GenerateApiTokenRequest_Expires::class);
